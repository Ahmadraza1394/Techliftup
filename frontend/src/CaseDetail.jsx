...
const caseData = {
  ...
  "tuatara-tourist": {
    ...
    overview:
      "Tuatara Tourist offers comprehensive tours and activities in Tuatara, providing visitors with authentic local experiences and adventures.",
    objectives: [
    ...
    conclusion:
      "The Tuatara Tourist website successfully bridges the gap between travelers and local experiences, providing an effective platform that benefits both tourists and local tour operators.",
  ...
  sonnetoai: {
    ...
    overview:
      "Sonneto AI is an innovative music streaming platform that leverages artificial intelligence to deliver personalized music recommendations based on user preferences, listening habits, and emotional states.",
    objectives: [
    ...
    conclusion:
      "Sonneto AI has successfully transformed how users discover and enjoy music through its intelligent recommendation system, creating a personalized experience that keeps listeners engaged and delighted.",
  ...
  intercity: {
    ...
    overview:
      "Inter City provides comprehensive bus booking services connecting major cities and rural areas, offering travelers a convenient and affordable transportation solution.",
    objectives: [
    ...
    conclusion:
      "Inter City has revolutionized bus travel booking by providing a reliable, user-friendly platform that connects travelers to their destinations efficiently while offering bus operators a valuable digital sales channel.",
  ...
  passionfarm: {
    ...
    overview:
      "Passion Farm is an ecommerce platform specializing in organic and sustainably grown products, connecting health-conscious consumers directly with ethical farmers and producers.",
    objectives: [
    ...
    conclusion:
      "Passion Farm successfully bridges the gap between organic producers and conscious consumers, creating a sustainable marketplace that benefits farmers, customers, and the environment alike.",
  ...
  cleanwater: {
    ...
    overview:
      "Clean Water provides comprehensive water treatment and purification services for residential, commercial, and industrial clients, ensuring access to safe, clean water through innovative filtration technologies.",
    objectives: [
    ...
    conclusion:
      "Clean Water's digital presence effectively communicates their expertise in water treatment solutions, positioning them as industry leaders while educating consumers about the importance of water quality and available solutions.",
  ...
  electrosanto: {
    ...
    overview:
      "Electro Santos provides premium electrical products and professional installation services for residential and commercial clients, focusing on energy efficiency, smart home solutions, and sustainable electrical systems.",
    objectives: [
    ...
    conclusion:
      "Electro Santos successfully established an online presence that balances product sales with service offerings, providing customers with comprehensive electrical solutions while building credibility through education and showcasing expertise.",
  ...
  hourglass: {
    ...
    overview:
      "The Hour Glass is a premium watch retailer offering a curated collection of luxury timepieces, providing watch enthusiasts with authentic, high-quality watches from renowned global brands.",
    objectives: [
    ...
    conclusion:
      "The Hour Glass successfully translated the premium in-store experience to digital, creating an online destination that respects the craftsmanship of luxury timepieces while providing a secure and sophisticated shopping environment.",
  ...
  "clearance-management-system": {
    ...
    overview:
      "The Clearance Management System is a comprehensive digital solution designed to streamline and automate the clearance process for educational institutions, replacing paper-based workflows with an efficient online system.",
    objectives: [
    ...
    conclusion:
      "The Clearance Management System has transformed an outdated, inefficient process into a streamlined digital experience, benefiting students, faculty, and administrative staff while providing better oversight and record-keeping for institutions.",
