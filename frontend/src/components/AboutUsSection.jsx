...
import { FaCheckCircle, FaCogs, FaUsers, FaLightbulb } from "react-icons/fa";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-sky-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <motion.div
            ...
            className="inline-block bg-white text-red-500 px-6 py-3 rounded-full text-sm font-bold mb-8 tracking-wide shadow-lg border border-sky-100"
          >
            <T>WHO WE ARE</T>
          </motion.div>
          <motion.h1
            ...
            className="text-3xl md:text-5xl lg:text-5xl font-extrabold bg-gradient-to-r from-sky-500 via-sky-500 to-sky-500 bg-clip-text text-transparent mb-8 leading-tight"
          >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative bg-gradient-to-br from-sky-400 to-sky-500 rounded-3xl overflow-hidden shadow-2xl border-2 border-sky-200/50 hover:shadow-3xl transition-all duration-500 group">
              <img
          ...
          >
            {/* <h2 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-sky-500 to-sky-600 bg-clip-text text-transparent mb-6">
              <T>TechLiftUp is the global leader in digital transformation.</T>
            </h2> */}
            <div className="space-y-6 text-gray-700 text-justify text-xl leading-relaxed">
              <p>
                <T>
              ...
              <p>
                <T>
                  ...
                  state-of-the-art MEP system, we deliver integrated solutions
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-sky-400 to-sky-500 p-8 md:p-12 rounded-3xl shadow-2xl text-white relative overflow-hidden">
            {/* <div className="absolute inset-0 bg-gradient-to-br from-sky-600/20 to-sky-600/20"></div> */}
        ...
        {/* <motion.div
          ...
          className=" rounded-3xl p-6 md:p-12 shadow-sm border border-sky-200/30 relative overflow-hidden"
        >
          ...
          <div className="absolute inset-0 opacity-5">
            <div
              ...
              style={{
                backgroundImage:
                  "radial-gradient(circle at 25% 25%, #0ea5e9 2px, transparent 2px)",
          ...
          <div className="relative z-10">
            <h3 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-sky-500 to-sky-500 bg-clip-text text-transparent mb-12 text-center">
              <T>Why Partner with TechLiftUp?</T>
            </h3>

            <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-8">
              <div className="group text-center bg-gradient-to-br from-sky-500 via-sky-400 to-sky-500  backdrop-blur-sm p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-sky-100 hover:border-sky-400 hover:-translate-y-2">
                ...
                <div className="mb-4">
                  <span className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-sky-600 to-sky-600 bg-clip-text text-transparent">
                    500+
                  </span>
                </div>
              ...
              <div className="group text-center bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-sky-100 hover:border-amber-300 hover:-translate-y-2">
                ...
                <div className="mb-4">
                  <span className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-sky-600 to-sky-600 bg-clip-text text-transparent">
                    <T>End-to-End</T>
                  </span>
                </div>
                <p className="text-gray-800 font-bold text-lg mb-2">
